...
froot = 'D:/PhD/Data/GDT_Pilot/'                                           #File location
#subjlist = ['Varsha_Pilot_New_Setup']                                     # Data of each subject stored in a folder in the file loc
condlist = [1,2,3]                                                         #List of conditions - Here GDs of 16, 32 and 64 ms
...
for subj in froot:
    ...
    raw.info ['bads'].extend (['A1', 'A2', 'A17','A18', 'A24', 'A28'])
